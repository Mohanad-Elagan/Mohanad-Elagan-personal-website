...
const experiences: ExperienceItem[] = [
  {
    ...
    startDate: '04/2025',
    endDate: 'Present',
    description: 'Social & Cognitive Origins Group\n• Engaged in comparative research discussions on social cognition, Theory of Mind, and primate behavior.\n• Synthesized literature on social perception, biological motion, and evolutionary cognition across humans and primates.',
    logoUrl: '/img/jhu.jpg',
  ...
  },
  {
    ...
    startDate: '08/2024',
    endDate: 'Present',
    description: 'Chemistry & Mathematics Department\n• Tutored and graded 70+ students, collaborating with faculty to enhance course materials and boost engagement.\n• Developed hands-on instructional modules modeling human sensory perception to improve experiential learning.',
    logoUrl: '/img/bc.png',
  ...
  },
  {
    ...
    startDate: '05/2025',
    endDate: '08/2025',
    description: 'Cardiac Surgery Department\n• Conducted clinical research examining psychophysiological and psychosocial factors for clinical decision-making.\n• Analyzed 4,000+ cases to model outcome trajectories and stratify clinical risk, supporting evidence-based assessment.\n• Integrated family/caregiver and social-context variables to inform screening and psychosocial risk stratification.',
    logoUrl: '/img/BWH.png',
